...
class ProductViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    private let hats: [Hat] = [
        ...
        Hat(name: "Greek Hat", price: 120, image: UIImage(named: "cap")!, usdzName: "greekhat0",position: SCNVector3(x: 0, y: 0.11, z: -0.05),scale: SCNVector3(x: 0.0065 , y: 0.0065, z: 0.0065), tilt: SCNVector3(x: 0, y: 0, z: 0) ),
