...
class ProductViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    private let hats: [Hat] = [
        ...
        Hat(name: "Cap fit", price: 120, image: UIImage(named: "newcap1.7")!, usdzName: "newcap1.7",position: SCNVector3(x: 0, y: 0.10, z: -0.01),scale: SCNVector3(x: 0.165 , y: 0.18, z: 0.165), tilt: SCNVector3(x: -0.2, y: 0, z: 0)),
        Hat(name: "Cap bez paska", price: 120, image: UIImage(named: "newcap1.7")!, usdzName: "newcap1.7bp",position: SCNVector3(x: 0, y: 0.10, z: -0.01),scale: SCNVector3(x: 0.165 , y: 0.18, z: 0.165), tilt: SCNVector3(x: -0.2, y: 0, z: 0)),
